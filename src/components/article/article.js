...
/*
  ...
  <div class="article"> // element 1
    <h2>{title of the article}</h2> // element 2
    <p class="date">{date of the article}</p> // element 3

    {three separate paragraph elements} // element 4,5,6

    <span class="expandButton">+</span> // element 7
  </div>
